 ...
 */
public abstract class MonthAdapter extends PagerAdapter implements OnDayClickListener {
    ...
    public CharSequence getPageTitle(int position) {
        MonthView v = mItems.get(position).calendar;
        if (v != null) {
            return v.getMonth() + ""; // TODO
        }
        return null;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        MonthView itemView = getView(position, null, container);
        final ViewHolder holder = new ViewHolder(position, container, itemView);
    ...
    //@Override
    public MonthView getView(int position, View convertView, ViewGroup parent) {
        MonthView v;
